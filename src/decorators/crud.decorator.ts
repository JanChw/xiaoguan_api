  ...
  return function (target: any) {
    ...
    const crud: Crud = {
      ...
      create: async (entity: any, opts = {}) => {
        ...
        return await Model.create(Object.assign(opts, { data: entity })).catch(err => console.error(err))
      },
      // TODO:如果有关联数据会报错
      ...
      update: async (id: number, entity: any, opts = {}) => {
        ...
        return await Model.update(Object.assign(opts, { where: { id }, data: entity })).catch(err => console.error(err))
      },
